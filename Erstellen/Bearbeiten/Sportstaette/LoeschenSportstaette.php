...
<div class="ramen">
<p>Sind Sie sicher, dass Sie die Sportstätte löschen wollen?</br>
Alle zur Sportstätte zugehörigen Daten werden unwideruflich gelöscht!</p>
</div>

<form action ="LoeschenSportstaette.php" method="Post">
...
<div class="Buttons">
<tr>
<th><a href="UebersichtSportstaette.php">Zurück</a></th>
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$sql = 'DELETE FROM kontakte_sportstaette WHERE SSID='.$ID.';';
	$result = $conn -> query($sql);
	...
	$sql = 'DELETE FROM sportstaette WHERE ID='.$ID.';';
	$result = $conn -> query($sql);
